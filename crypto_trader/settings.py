...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY", "django-insecure-fallback-secret-key-for-dev-only"
)
...
CELERY_BEAT_SCHEDULE = {
    "update-crypto-prices-every-5-minutes": {
        ...
        "schedule": 60.0,  # Executar a cada 300 segundos (5 minutos)
        # 'args': (16, 16) # Argumentos para a tarefa, se necessário
    },
}
